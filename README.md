...
uv run directions serial --config configs/serial.yaml --fv-run <comp run> --learned-run <comp_learned run> --run-id serial_<model>   # the serial injection test (D41): the components' controls one after the other
```
