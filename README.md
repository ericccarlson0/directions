...
uv run python scripts/family_geometry.py --learned-run <learned family run> --fv-run <head-mean family run> --labels kth_1,kth_2,kth_3,kth_4,kth_5 --params 1,2,3,4,5   # the within-family geometry (D39)
```
